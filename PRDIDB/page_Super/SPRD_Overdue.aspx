<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SPRD_Overdue.aspx.cs" Inherits="PRDIDBSystem.page_Super.SPRD_Overdue" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article" style="width: auto">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">PRD DATA (Overdue)</h2>
                ...
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell layout-item-1">
                        ...
                        <p><span style="text-align: left">
                            <b><asp:Literal ID="ltrPlant" runat="server"></asp:Literal>
                               &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Literal ID="ltrTotalArea" runat="server"></asp:Literal>
                                 Area&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Literal ID="ltrTotalPRD" runat="server"></asp:Literal>
                                PRD</b>
                        &nbsp;&nbsp;</span><asp:ImageButton ID="imbRemove" runat="server" ImageUrl="~/images/icon/remove.png" Height="25px" OnClick="imbRemove_Click" OnClientClick="if(confirm('Do you want to remove data?')== false) return false;"/>
                        </p>
