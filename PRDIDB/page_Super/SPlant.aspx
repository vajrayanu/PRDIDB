<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SPlant.aspx.cs" Inherits="PRDIDBSystem.page_Super.SPlant" StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Plant</h2>
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%">
                        <p style="text-align: right;">Select Complex&nbsp;</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 50%">
                        <p>
                            &nbsp;<asp:DropDownList ID="ddlComplex" runat="server" Height="22px" Width="210px" DataValueField="complex_ID" DataTextField="Name" AutoPostBack="True" OnSelectedIndexChanged="ddlComplex_SelectedIndexChanged"></asp:DropDownList>&nbsp;<br />
                        </p>
                    </div>
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%;vertical-align:bottom">
                        <p style="text-align: right;"><asp:CheckBox ID="chkAll" runat="server" Text="search all" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Plant's Name</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 50%">
                        <p>
                    ...
                    <div class="irpc-layout-cell" style="width: 25%; border:solid 1px;" >
                        <p style="text-align:center">Set Plant Status&nbsp;</p>
                        <p style="text-align:center">
                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" BorderStyle="None" RepeatDirection="Horizontal" RepeatLayout="Flow">
                             ...
                             <asp:ImageButton ID="ImageButton1" runat="server" Height="22px" Width="67px" ImageUrl="~/images/button/submit-button01.png" OnClick="imbSubmit_Click" ValidationGroup="A" OnClientClick="if(confirm('Do you want to submit data?') == false) return false;"/>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 100%">
                        ...
                        <p>Data List</p>
                            ...
                            <asp:GridView ID="gvPlant" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvPlant_PageIndexChanging" PageSize="20" AllowPaging="True">
                                ...
                                <asp:BoundField HeaderText="Plant No." DataField="ID">
                                    ...
                                    <asp:BoundField DataField="Responsible_by" HeaderText="Responsible by" />
