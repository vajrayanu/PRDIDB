<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SPRD_Data.aspx.cs" Inherits="PRDIDBSystem.page_Super.SPRD_Data" StylesheetTheme="siteSkin" %>
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix">
                ...
                <div class="irpc-content-layout-row">
                    ...
                    <div class="irpc-layout-cell" style="width: 67%; vertical-align: middle">
                        ...
                        <asp:Panel ID="pYear" runat="server">
                            Select Year&nbsp;<asp:DropDownList ID="ddlYear" runat="server" Height="22px" Width="136px" DataTextField="Year_2" DataValueField="Year">
                            </asp:DropDownList>
            ...
            <asp:Panel ID="pShowData" runat="server">
                    ...
                    <div class="irpc-content-layout">
                        <div class="irpc-content-layout-row">
                            <div class="irpc-layout-cell layout-item-2" style="width: 100%; text-align: center;">
                                ...
                                &nbsp;<asp:ImageButton ID="imbEdit" runat="server" Height="22px" ImageUrl="~/images/icon/edit.png" OnClick="imbEdit_Click" />
                                &nbsp;<asp:ImageButton ID="imbRemove" runat="server" Height="22px" ImageUrl="~/images/icon/remove.png" OnClick="imbRemove_Click1" ToolTip="remove" OnClientClick="if(confirm('Do you want to remove data?')== false) return false;"/>
                            ...
                            <asp:Panel ID="pProcessData" runat="server">
                                <table class="irpc-article" style="width: 100%; background-color: bisque;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="border-width: 0px; text-align: right; " class="auto-style18">Registration Date</td>
                                            <td style="border-width: 0px; vertical-align: middle" class="auto-style18">
                                                <asp:TextBox ID="txtRegistration_DatePicker" runat="server" Wrap="False"></asp:TextBox>
                                                DD/MM/YYYY</td>
                                            <td style="border-width: 0px; text-align: right; " class="auto-style18">Cold Diff-Test Press.<br>
                                            </td>
                                            <td style="border-width: 0px;" class="auto-style18">
                                    ...
                                    <td style="border-width: 0px;" class="auto-style10">
                                        ...
                                        <tr>
                                            <td style="border-width: 0px; text-align: right; " class="auto-style19">Record By</td>
                                            <td style="border-width: 0px; text-align: -webkit-auto; " class="auto-style19">
                                                <asp:TextBox ID="txtRecord" runat="server"></asp:TextBox>
                                            </td>
                                            <td style="border-width: 0px; text-align: right; " class="auto-style19"><span style="text-align: right;">Set Press.</span></td>
                                            <td style="border-width: 0px;" class="auto-style19">
                                ...
                                <table class="irpc-article" style="width: 100%; background-color: aliceblue;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 25%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;" class="">
                                                <asp:DropDownList ID="ddlValve_Type" runat="server" Height="22px" Width="100%">
                            ...
                            <asp:Panel ID="pAttachment" runat="server">
                                <table class="irpc-article" style="width: 100%; background-color: aliceblue;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="border-width: 0px; text-align: center;" colspan="2">
                ...
                <div style="text-align: center">
                    <span style="line-height: 18px; -webkit-border-horizontal-spacing: 2px; -webkit-border-vertical-spacing: 2px; text-align: center;">
                        ...
                        <asp:ImageButton ID="imbCancel" runat="server" Height="27px" SkinID="cancel1" OnClientClick="if(confirm('Cancel ?')== false) return false;" OnClick="imbCancel_Click" /></span>
                </div>
            </asp:Panel>
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
