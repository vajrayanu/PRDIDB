<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SUpdateUnit.aspx.cs" Inherits="PRDIDBSystem.page_Super.SUpdateUnit" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Update Unit</h2>
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%; vertical-align: middle">
                        <p style="text-align: right;">&nbsp;<span style="line-height: 16px;">Select Type</span></p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 75%">
                        <p>
                            &nbsp;<asp:DropDownList ID="ddlType" runat="server" Height="22px" Width="175px">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%; vertical-align:middle">
                        <p style="text-align: right;">&nbsp;<span style="line-height: 16px; text-align: center;"> Unit</span></p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 75%">
                        <p>
                            &nbsp;<asp:TextBox ID="txtUnit" runat="server" Width="200px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUnit" ErrorMessage="* please enter unit" ForeColor="#CC0000" ValidationGroup="A" Display="Dynamic"></asp:RequiredFieldValidator>
                        </p>
                    </div>
                    <%--<div class="irpc-layout-cell" style="width: 10%">
                        <p>
