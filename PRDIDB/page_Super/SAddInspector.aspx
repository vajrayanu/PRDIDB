<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SAddInspector.aspx.cs" Inherits="PRDIDBSystem.page_Super.SAddInspector" StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    ...
    <article class="irpc-post irpc-article" >
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Add New Inspector</h2>
