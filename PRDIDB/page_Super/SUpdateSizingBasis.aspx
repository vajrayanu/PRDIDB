<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SUpdateSizingBasis.aspx.cs" Inherits="PRDIDBSystem.page_Super.SUpdateSizingBasis"  StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Update Sizing Basis</h2>
...
<div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%; vertical-align: middle">
                        <p style="text-align: right;">Sizing Basis</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 75%">
                        <p>
                            &nbsp;<asp:TextBox ID="txtSizing" runat="server" Width="200px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSizing" ErrorMessage="* please enter sizing basis" ForeColor="#CC0000" ValidationGroup="A" Display="Dynamic"></asp:RequiredFieldValidator>
                        </p>
                    </div>
