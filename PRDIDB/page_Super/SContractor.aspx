<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SContractor.aspx.cs" Inherits="PRDIDBSystem.page_Super.SContractor" StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Manufacturer</h2>
                ...
                <div class="irpc-content-layout">
                    <div class="irpc-content-layout-row">
                        <div class="irpc-layout-cell" style="width: 100%;vertical-align:bottom">
                            <p>
                                &nbsp;<asp:ImageButton ID="imb" runat="server" SkinID="add1" Height="22px" OnClick="imbAddNew_Click" />
                            <br>
                            </p>
                        </div>
                    </div>
                ...
                <div class="irpc-content-layout">
                    <div class="irpc-content-layout-row">
                        <div class="irpc-layout-cell" style="width: 100%">
                            ...
                            <asp:GridView ID="gvContractor" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvContractor_PageIndexChanging" PageSize="20" AllowPaging="True">
                                ...
                                <asp:BoundField DataField="Contractor_ID" >
                                ...
                                <asp:BoundField HeaderText="Manufacturer Name
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="imbEdit" runat="server" Height="22px" ImageUrl="~/images/icon/edit.png" OnClick="imb_Click" />
                                    </ItemTemplate>
