<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SUpdateServiceFluid.aspx.cs" Inherits="PRDIDBSystem.page_Super.SUpdateServiceFluid" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Update Service Fluid</h2>
              ...
              <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%; vertical-align: middle">
                        <p style="text-align: right;">&nbsp;Service Fluid</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 75%">
                        <p>
                            &nbsp;<asp:TextBox ID="txtServiceFluid" runat="server" Width="200px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtServiceFluid" ErrorMessage="* please enter service fluid" ForeColor="#CC0000" ValidationGroup="A" Display="Dynamic"></asp:RequiredFieldValidator>
                        </p>
                    </div>
