<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SAddSizingBasis.aspx.cs" Inherits="PRDIDBSystem.page_Super.SAddSizingBasis"  StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Add New Sizing Basis</h2>
