<%@ Page Title="" Language="C#" MasterPageFile="~/design/SuperMasterPage.Master" AutoEventWireup="true" CodeBehind="SUpdatePRD_Type.aspx.cs" Inherits="PRDIDBSystem.page_Super.SUpdatePRD_Type" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    ...
    <article class="irpc-post irpc-article" >
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Update PRD Type</h2>
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 15%;vertical-align:middle">
                        <p style="text-align: right;">Type Name</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 85%">
                        <p>&nbsp;<asp:TextBox ID="txtType" runat="server" Width="75px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtType" ErrorMessage="* please enter type" ForeColor="#CC0000" ValidationGroup="A" Display="Dynamic"></asp:RequiredFieldValidator>
                        &nbsp;Description <asp:TextBox ID="txtDescription" runat="server" Width="250px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDescription" ErrorMessage="* please enter description" ForeColor="#CC0000" ValidationGroup="A" Display="Dynamic"></asp:RequiredFieldValidator>
                        </p>
                    </div>
