<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SHeader.ascx.cs" Inherits="PRDIDBSystem.web_Control.SHeader" %>
    ...
    <div id="irpc-flash-area">
        <div id="irpc-flash-container">
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="900" height="225" id="irpc-flash-object">
                <param name="movie" value="../images/Sweb/flash.swf">
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="../images/Sweb/flash.swf" width="900" height="225">
                    <param name="quality" value="high">
                    <param name="scale" value="exactfit">
                    <param name="wmode" value="transparent">
                    <param name="flashvars" value="color1=0xFFFFFF&amp;alpha1=.50&amp;framerate1=24&amp;loop=true&amp;wmode=transparent">
