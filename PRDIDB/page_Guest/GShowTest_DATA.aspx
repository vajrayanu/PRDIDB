<%@ Page Title="" Language="C#" MasterPageFile="~/design/GuestMasterPage.Master" AutoEventWireup="true" CodeBehind="GShowTest_DATA.aspx.cs" Inherits="PRDIDBSystem.page_Guest.GShowTest_DATA" %>
                    ...
                    <div class="irpc-layout-cell layout-item-3" style="width: 100%">
                        <table class="irpc-article" style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 25%; text-align: right; vertical-align: middle; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;"></td>
                                    <td style="text-align: -webkit-auto; width: 75%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;" colspan="3">
                                        &nbsp;</td>
                                </tr>
                            </tbody>
