<%@ Page Title="" Language="C#" MasterPageFile="~/design/GuestReportMasterPage.Master" AutoEventWireup="true" CodeBehind="GSummary_Status_prd_Report2.aspx.cs" Inherits="PRDIDBSystem.page_Guest.GSummary_Status_prd_Report2" %>
                    ...
                    <div class="irpc-layout-cell layout-item-1" style="width: auto; vertical-align: middle; text-align: right">
                        <p>
                            <span style="text-align: right">
                                <asp:DropDownList ID="ddlYear" runat="server" Height="22px" Width="137px" DataTextField="text" AutoPostBack="True" DataValueField="year" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
