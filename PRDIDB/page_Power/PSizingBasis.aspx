<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerMasterPage.Master" AutoEventWireup="true" CodeBehind="PSizingBasis.aspx.cs" Inherits="PRDIDBSystem.page_Power.PSizingBasis"  StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Sizing Basis</h2>
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%;vertical-align:bottom">
                        <p style="text-align: right;"><asp:CheckBox ID="chkAll" runat="server" Text="search all" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sizing Basis</p>
                    </div>
                ...
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 100%">
                        ...
                        <p>Data List</p>
                            ...
                            <asp:GridView ID="gvSizing_Basis" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvSizing_Basis_PageIndexChanging" PageSize="20" AllowPaging="True">
                                ...
                                <HeaderStyle Width="32%" />
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="Sizing Basis">
                                    <HeaderStyle Width="32%" />
                                    </asp:BoundField>
