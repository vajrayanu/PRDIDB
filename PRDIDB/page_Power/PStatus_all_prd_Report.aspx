<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerReportMasterPage.Master" AutoEventWireup="true" CodeBehind="PStatus_all_prd_Report.aspx.cs" Inherits="PRDIDBSystem.page_Power.PStatus_all_prd_Report" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article" style="width: auto">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">&nbsp;TEST PRD REPORT(LAST TEST ONLY)</h2>
