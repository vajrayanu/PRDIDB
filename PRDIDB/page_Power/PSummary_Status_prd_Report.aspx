<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerReportMasterPage.Master" AutoEventWireup="true" CodeBehind="PSummary_Status_prd_Report.aspx.cs" Inherits="PRDIDBSystem.page_Power.PSummary_Status_prd_Report" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
     <article class="irpc-post irpc-article" style="width: auto">
        ...
        <%-- <asp:BoundField DataField="NoTest" HeaderText="No Test">
                                <HeaderStyle Width="10%" />
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>--%><%--<div class="irpc-content-layout-wrapper layout-item-0">
