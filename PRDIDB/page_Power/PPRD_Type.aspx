<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerMasterPage.Master" AutoEventWireup="true" CodeBehind="PPRD_Type.aspx.cs" Inherits="PRDIDBSystem.page_Power.PPRD_Type" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">PRD Type</h2>
                ...
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 100%">
                        <div class="irpc-content-layout-row">
                            ...
                            <asp:GridView ID="gvPRD_Type" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvPRD_Type_PageIndexChanging" PageSize="20" AllowPaging="True">
                                ...
                                <asp:BoundField HeaderText="RPD Type" DataField="prd_type">
