<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerMasterPage.Master" AutoEventWireup="true" CodeBehind="PComplex.aspx.cs" Inherits="PRDIDBSystem.page_Power.PComplex" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Complex</h2>
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 100%">
                        ...
                        <asp:GridView ID="gvComplex" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvComplex_PageIndexChanging" PageSize="20" AllowPaging="True">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Complex No." DataField="complex_ID">
                                ...
                                <asp:BoundField DataField="Name" HeaderText="Complex Name">
                                    <HeaderStyle Width="32%" />
                                </asp:BoundField>
