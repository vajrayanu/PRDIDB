<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerMasterPage.Master" AutoEventWireup="true" CodeBehind="PPlant.aspx.cs" Inherits="PRDIDBSystem.page_Power.PPlant" StylesheetTheme="siteSkin"%>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%; height: 19px;">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%;vertical-align:bottom">
                        <p style="text-align: right;"><asp:CheckBox ID="chkAll" runat="server" Text="search all" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Plan's Name</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 50%">
                        <p>
                    ...
                    <div class="irpc-layout-cell" style="width: 100%">
                        ...
                        <p>Data List</p>
                            ...
                            <asp:GridView ID="gvPlant" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvPlant_PageIndexChanging" PageSize="20" AllowPaging="True">
                                ...
                                <asp:BoundField HeaderText="Plan No." DataField="ID">
                                ...
                                <HeaderStyle Width="32%" />
                                    ...
                                    <asp:BoundField DataField="plant_Name" HeaderText="Plan Name">
                                    <HeaderStyle Width="32%" />
                                    </asp:BoundField>
                                ...
                                <%--<asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imbEdit" runat="server" Height="22px" ImageUrl="~/images/icon/edit.png" />
                                    </ItemTemplate>
