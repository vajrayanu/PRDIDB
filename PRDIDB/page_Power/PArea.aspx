<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerMasterPage.Master" AutoEventWireup="true" CodeBehind="PArea.aspx.cs" Inherits="PRDIDBSystem.page_Power.PArea" StylesheetTheme="siteSkin" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">Area</h2>
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%">
                        <p style="text-align: right;">Select Plant&nbsp;</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 50%">
                        <p>
                            &nbsp;<asp:DropDownList ID="ddlPlant" runat="server" Height="22px" Width="217px" AutoPostBack="True" DataTextField="plant_Name" DataValueField="ID" OnSelectedIndexChanged="ddlPlant_SelectedIndexChanged"></asp:DropDownList><br>
                        </p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 25%; ">
                        <p>
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 25%;vertical-align:bottom">
                        <p style="text-align: right;"><asp:CheckBox ID="chkAll" runat="server" Text="search all" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Area Name</p>
                    </div>
                    <div class="irpc-layout-cell" style="width: 50%">
            ...
            <div class="irpc-content-layout">
                <div class="irpc-content-layout-row">
                    <div class="irpc-layout-cell" style="width: 100%">
                        ...
                        <asp:GridView ID="gvArea" runat="server" ShowFooter="True" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnPageIndexChanging="gvArea_PageIndexChanging" PageSize="20" AllowPaging="True">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Area No." DataField="area_ID">
