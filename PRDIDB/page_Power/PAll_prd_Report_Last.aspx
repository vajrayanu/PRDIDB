<%@ Page Title="" Language="C#" MasterPageFile="~/design/PowerReportMasterPage.Master" AutoEventWireup="true" CodeBehind="PAll_prd_Report_Last.aspx.cs" Inherits="PRDIDBSystem.page_Power.PAll_prd_Report_Last" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="SheetContentPlaceHolder" runat="server">
    <article class="irpc-post irpc-article" style="width: auto">
        <div class="irpc-postmetadataheader">
            <h2 class="irpc-postheader">ALL PRD REPORT (LAST TEST ONLY)</h2>
        ...
        <div class="irpc-postcontent irpc-postcontent-0 clearfix"  style="width:auto">
            <div class="irpc-content-layout layout-item-0">
                <div class="irpc-content-layout-row">
                    ...
                    <div class="irpc-layout-cell layout-item-1" style="width: 50%; text-align: right;">
                        <%--<asp:Button ID="btnExcel" runat="server" Height="22px" Text="Export to PDF"/>--%>
                     &nbsp;
                        <asp:Button ID="btnExportToExcel" runat="server" Height="22px" OnClick="btnExportToExcel_Click" Text="Export To Excel" />
                    </div>
                </div>
            </div>
        </div>
